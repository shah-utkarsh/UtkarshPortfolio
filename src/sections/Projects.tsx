    ...
    <section className="pb-16 lg:py-24">
      <div className="container">
        <div className="flex justify-center ">
          <p className=" font-semibold uppercase tracking-widest bg-gradient-to-r from-emerald-300 to-sky-400 bg-clip-text text-transparent text-center">
            Real World Projects
          </p>
        </div>
        ...
        <p className="text-center md:text-lg lg:text-xl text-white/60 mt-4 max-w-md mx-auto ">
          See how I transformed ideas into implemented solutions with the help
          of technology.
        </p>
